              ...
              <Card>
                <CardContent className="p-6">
                  <div className="text-center space-y-4">
                    ...
                    <div className="text-sm text-muted-foreground space-y-1 bg-secondary/40 p-4 rounded-lg">
                      <p className="font-medium text-foreground/80 mb-2">📷 Photo Guidelines:</p>
