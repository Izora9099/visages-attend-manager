  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <h4 className="font-medium text-foreground">Professional Details</h4>
          <div className="space-y-2">
            {teacher.department && (
              <div className="flex items-center space-x-2">
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage teacher accounts, departments, and course assignments</p>
        </div>
        ...
        <CardContent className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="relative">
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground/60" size={20} />
              <Input
                    ...
                    <TableRow key={teacher.id}>
                      ...
                      <TableCell>
                        <div className="space-y-1">
                          <div className="flex items-center text-sm">
                            <Mail className="h-3 w-3 mr-1 text-muted-foreground/60" />
                            {teacher.email}
                          </div>
                          {teacher.phone && (
                            <div className="flex items-center text-sm text-muted-foreground">
                              <Phone className="h-3 w-3 mr-1 text-muted-foreground/60" />
                              {teacher.phone}
                            </div>
                          )}
                        </div>
                      ...
                      <TableCell>
                        <div className="flex items-center">
                          <Building className="h-4 w-4 mr-2 text-muted-foreground/60" />
