...
export const TimetableManager = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          { value: '5', label: 'Time Slots', color: 'text-blue-500' },
          { value: '5', label: 'Classrooms', color: 'text-green-500' },
          { value: '4', label: 'Departments', color: 'text-purple-500' },
          { value: 'Mon–Fri', label: 'Working Days', color: 'text-orange-500' },
