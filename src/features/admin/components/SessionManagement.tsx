                ...
                <Card key={session.id} className="border-l-4 border-l-green-500">
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        <div className="text-muted-foreground">Check-in Method</div>
                    ...
                    <TableRow key={session.id}>
                      <TableCell>
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">{session.course_name}</div>
                        </div>
                      </TableCell>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Automatically close sessions when duration expires</p>
                  </div>
                  <input
                    type="checkbox"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Send notifications for session events</p>
                  </div>
                  <input
                    type="checkbox"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Allow manual attendance editing</p>
                  </div>
                  <input
                    type="checkbox"
                        ...
                        <TableRow key={checkIn.id}>
                          <TableCell>
                            <div>
                              ...
                              <div className="text-sm text-muted-foreground">{checkIn.student_number}</div>
                            </div>
                          </TableCell>
                          <TableCell>
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={course.course_code} className="border rounded p-3 hover:bg-secondary/40 cursor-pointer"
