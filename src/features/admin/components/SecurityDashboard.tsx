    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Monitor system security and user activities</p>
        </div>
              ...
              <div className="space-y-2">
                {filteredActivities && filteredActivities.length > 0 ? (
                  filteredActivities.map((activity) => {
                    ...
                    return (
                      <div key={activity.id} className="grid grid-cols-1 lg:grid-cols-8 gap-4 p-3 border rounded-lg text-sm hover:bg-secondary/40">
                        <div className="flex items-center space-x-2">
                          {getActivityIcon(activity.action)}
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Send notifications for unusual behavior</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Users can be logged in from multiple devices</p>
                    </div>
                    <Switch
