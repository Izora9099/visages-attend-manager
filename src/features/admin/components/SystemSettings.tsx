            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Block access for system maintenance</p>
                </div>
                <Switch
              ...
              <div>
                ...
                <Textarea
                  ...
                  rows={3}
                />
                <p className="text-xs text-muted-foreground mt-1">Will be displayed to all users</p>
              </div>
